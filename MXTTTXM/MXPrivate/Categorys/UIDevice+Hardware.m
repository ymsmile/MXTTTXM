...
- (NSString*)hardwareSimpleDescription {
    ...
    if ([hardware isEqualToString:@"iPod7,1"])      return @"iPod Touch 6G";
    ...
    if ([hardware isEqualToString:@"iPad3,6"])      return @"iPad 4 (CDMA)";
    if ([hardware isEqualToString:@"iPad4,1"])      return @"iPad Air (WiFi)";
    if ([hardware isEqualToString:@"iPad4,2"])      return @"iPad Air (GSM)";
    if ([hardware isEqualToString:@"iPad4,3"])      return @"iPad Air (CDMA)";
    if ([hardware isEqualToString:@"iPad4,4"])      return @"iPad Mini Retina (WiFi)";
    if ([hardware isEqualToString:@"iPad4,5"])      return @"iPad Mini Retina (Cellular)";
